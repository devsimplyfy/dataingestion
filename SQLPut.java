...
public class SQLPut extends AbstractSessionFactoryProcessor {
    ...
    private GroupingFunction groupFragmentedTransaction = (context, session, fc, conn, flowFiles, groups, sqlToEnclosure, result) -> {
        ...
        for (final FlowFile flowFile : flowFiles) {
            final String sql = context.getProperty(SQLPut.SQL_STATEMENT).isSet()
                    ? context.getProperty(SQLPut.SQL_STATEMENT).evaluateAttributeExpressions(flowFile).getValue()
